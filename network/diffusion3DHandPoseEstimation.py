...
class Diffusion3DHandPoseEstimation(torch.nn.Module):
    ...
    def forward(self, img, camera_intrinsic_matrix, pose_x0):
        ...
        refined_joint_coord = self.forward_kinematics_module(root_angles, other_angles, bone_lengths, camera_intrinsic_matrix)
